...
This project is a secure **Inventory Management System** backend built with **Spring Boot 3.5**. It features a robust, role-based authentication layer using **JSON Web Tokens (JWT)** to manage access for different types of users (Admin, Supplier, Staff).
...
- **STAFF**: Access to daily operations and inventory tracking.
...
| `/api/v1/staff/**`   | GET | Staff/Admin    | Staff-specific operations. |
